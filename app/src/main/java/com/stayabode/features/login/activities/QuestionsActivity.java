...
public class QuestionsActivity extends BaseActivity implements QuestionsView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //For question set of list
        Intent listQuestion = getIntent();
        if (listQuestion.getExtras().getString("mCurrentGroupList") != null) {
            int val = Integer.parseInt(listQuestion.getExtras().getString("mCurrentGroupList"));
            if(val != 0){
                mCurrentGroup = val;
            }
        }
        ...
        showFirstQuestion(mCurrentGroup);
        ...
        mBtnNextQuestion.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mCurrentApr != null) {
                    ...
                    mCurrentQuestionIndex++;
                    showNextQuestion(mCurrentGroup);
                }
            }
        });
...
//
    ...
    private void showFirstQuestion(int mCurrentGroup) {
