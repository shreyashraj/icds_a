...
/**
 * Created by Arpit on 13-01-2017.
 */
...
import java.util.Locale;
 ...
 public class PinEntryCustomEditText extends EditText {
    ...
    protected float mTextBottomPadding = 18; //8dp by default, height of the text from our lines
    ...
    protected PinEntryCustomEditText.OnPinEnteredListener mOnPinEnteredListener = null;
    ...
    public PinEntryCustomEditText(Context context) {
        super(context);
    }

    public PinEntryCustomEditText(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public PinEntryCustomEditText(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public PinEntryCustomEditText(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
     ...
     */
    public void updateColorForLines(boolean hasTextOrIsNext) {
        if (mHasError) {
    ...
    private void animatePopIn() {
        ...
        va.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                PinEntryCustomEditText.this.invalidate();
            }
        });
    ...
    public void setOnPinEnteredListener(PinEntryCustomEditText.OnPinEnteredListener l) {
